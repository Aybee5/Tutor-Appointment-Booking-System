...
async function getData() {
      ...
      try {
        let res = await fetch(`https://tutor-appointment-booking-system.onrender.com/teacherSlots/${email}`, {
              method: "GET",
              headers: {
...
let all_accept_btns = document.querySelectorAll(".accept")
   ...
   function accept(id){
     fetch(`https://tutor-appointment-booking-system.onrender.com/update/${id}`, {
        method:"PATCH",
        headers:{
          "Content-Type": "application/json",
          "Authorization":token
